                            ...
                            <form method="POST" action="{{ route('siswa.update', $siswa->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="d-flex">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nis" name="nis" class="form-control @error('nis') is-invalid @enderror" placeholder="{{ __('NIP Dosen') }}" value="{{ $siswa->nis }}">
                                    </div>
                                    <div class="form-group ml-4">
                                        <label for="telp">No. Telpon</label>
                                        <input type="text" id="telp" name="telp" class="form-control @error('telp') is-invalid @enderror" placeholder="{{ __('No. Telpon Dosen') }}" value="{{ $siswa->telp }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Alamat</label>
                                ...
                                <div class="form-group">
                                    <label for="kelas_id">Jabatn</label>
